...
public class ChapterOrderReceiver extends MessageListenerAdapter {
	...
	public void onMessage(Message message, Session session) throws JMSException {
		...
		Integer courseId = Integer.valueOf(model.getBizExtra());
		List<String> chapterIdList = model.getDetailBizExtra();
		
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("userId", userId);
		params.put("chapterIdList", chapterIdList);
		commonMapper.insert("ProgressCourse.insertProgressCourseList", params);
		...
		message.acknowledge();
//		
//		Integer chapterId = Integer.valueOf(chapterIdList.get(0).toString());
