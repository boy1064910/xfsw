...
<script type="text/javascript" src="/js/manager/account/role/initAdd.js"></script>
</head>
<body>
	<form class="Ding-Form form" id="editRoleForm" action="<%=request.getContextPath()%>/manager/account/role/addRole.shtml" submitValidation="submitValidation" successCallback="success">
		<div class="panel">
