...
<script type="text/javascript" src="/xfsw-web-manager/js/root/tenant/initEditRole.js"></script>
</head>
<body>
	<input type="hidden" id="tenantId" value="${tenantId }" />
	<form class="Ding-Form form" id="editRoleForm" method="post"
		action="/xfsw-web-manager/root/tenant/updateRole.shtml" submitValidation="submitValidation" successCallback="success">
		<div class="panel">
