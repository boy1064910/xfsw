...
@Rollback(true)
public class CategoryAuthorityCacheServiceTester {

	@Resource(name = "categoryAuthorityCacheService")
	private CategoryAuthorityCacheService categoryAuthorityCacheService;

	@Test
	public void selectListByIds() {
		long startTime = System.currentTimeMillis();
		Integer[] ids = new Integer[] { 1, 6, 9, 11, 2, 3, 4, 5, 7, 8, 10, 13, 14, 12, 16, 15, 17 };
		System.out.println(JsonUtil.entity2Json(categoryAuthorityCacheService.selectListByIds(ids)));
